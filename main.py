...
flags.DEFINE_string("out_name", "KaiFaZheZuiShuai", "Folder (under out_root_dir) for all outputs. Generated automatically if left blank []")###("out_name", "", "Folder (under out_root_dir) for all outputs. Generated automatically if left blank []")###
...
flags.DEFINE_integer("sample_freq", 30, "sample every this many iterations")###产生样本的频率，默认200，UP主建议30
flags.DEFINE_integer("ckpt_freq", 100, "save checkpoint every this many iterations")###储存模型的频率，默认200，UP主建议100
